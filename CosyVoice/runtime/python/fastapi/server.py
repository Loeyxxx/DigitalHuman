...
def save_upload_to_temp_wav(upload: UploadFile) -> str:
...
async def inference_zero_shot(tts_text: str = Form(), prompt_text: str = Form(), prompt_wav: UploadFile = File()):
    tmp_path = save_upload_to_temp_wav(prompt_wav)
    ...
    return StreamingResponse(stream_and_cleanup(), media_type="application/octet-stream")
